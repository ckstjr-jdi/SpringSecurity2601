...
/*
시큐리티가 /login주소요청이 오면 낚아체서 로그인을 진행함
로그인 진행이 완료되면 시큐리티가 가진 session을 만들어줌
같은 세션 공간인데 시큐리티만의 공간이 있음.(Security ContextHolder에 키를 저장)
...
Authentication객체는 PrincipalDetailService에서 만들어줌
*/
public class PrincipalDetails implements UserDetails {
    ...
    // 계정 활성화 여부(사용 가능 여부)
    // true: 사용 가능(로그인 가능)
    // false: 비활성화(로그인 불가) - 휴먼계정, 탈퇴, 이메일 미인증
    @Override
